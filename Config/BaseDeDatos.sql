...
--
-- Servidor: db
-- Tiempo de generación: 02-10-2024 a las 02:07:59
...
CREATE TABLE `Agenda` (
  ...
  `agendados` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL
...
CREATE TABLE `Calificacion` (
  `id` int NOT NULL,
  `puntMaxima` int DEFAULT NULL,
  `fuerzaMusc` int DEFAULT NULL,
  `resMusc` int DEFAULT NULL,
  `resAnaerobica` int DEFAULT NULL,
  `resilicencia` int DEFAULT NULL,
  `flexibilidad` int DEFAULT NULL,
  `cumpAgenda` int DEFAULT NULL,
  `resMonotonia` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Cliente` (
  `nroDocumento` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `tipoDocumento` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `esquina` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `patologias` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `ComboEjercicio` (
  `nombreCombo` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `Deportista` (
  `nroDocumento` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `tipoDocumento` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
  `posicion` varchar(15) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Ejercicio` (
  ...
  `tipoEjercicio` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `grupoMuscular` varchar(20) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Elige` (
  ...
  `nombrePlan` varchar(12) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Entrena` (
  `nombre` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `nroDocumento` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `tipoDocumento` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `LocalGym` (
  ...
  `calle` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `nroPuerta` varchar(4) COLLATE utf8mb4_general_ci NOT NULL,
  `esquina` varchar(25) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `Obtiene` (`nroDocumento`, `tipoDocumento`, `id`, `fecha`, `puntEsperado`, `puntObtenido`) VALUES
('55852116', 'ci', 1, '2024-10-02', 100, 125),
('55852116', 'ci', 2, '2024-10-02', 100, 125),
('55852117', 'ci', 3, '2024-10-02', 100, 125),
('55852117', 'ci', 4, '2024-10-02', 100, 125),
('55852118', 'ci', 5, '2024-10-02', 100, 125),
('55852118', 'ci', 6, '2024-10-02', 100, 125);
...
CREATE TABLE `Paciente` (
  `nroDocumento` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `tipoDocumento` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
  `fisioterapia` varchar(2) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Pago` (
  `idPago` int NOT NULL,
  `ultimoMesAbonado` varchar(12) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `PlanPago` (
  `nombrePlan` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tipoPlan` varchar(12) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Rutina` (
  ...
  `dia` varchar(8) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `SeAgenda` (
  ...
  `horaFin` time NOT NULL,
  `fecha` date DEFAULT NULL,
  `asistencia` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Usuario` (
  `nroDocumento` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `rol` varchar(35) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
ALTER TABLE `Obtiene`
  ...
  ADD CONSTRAINT `Obtiene_ibfk_2` FOREIGN KEY (`id`) REFERENCES `Calificacion` (`id`);
